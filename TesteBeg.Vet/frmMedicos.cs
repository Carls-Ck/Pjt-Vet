    ...
    public partial class frmMedicos : Form
    {
        ...
        private void dtgMedicos_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                {
                    //Se isso for verdade, atribui a todos o campos do formulário os respectivos conteúdos do banco sobre o médico clicado.
                ...
                else
                {
                        ...
                        MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
                        try
                        {
                            //Acessa o método Excluir da classe Funcionários, excluindo os registros, tendo como base a coluna ID_MEDICO.
                            novoMedico = new Medico();
